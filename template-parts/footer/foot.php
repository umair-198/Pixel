        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-12 mb-40">
                <div class="co-footer-widget-1">
                    <img src="<?php echo get_template_directory_uri()?>/assets/img/logo/footer-logo-light.png" alt="">
        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="co-copyright-1 text-center">
                    <p>Copyright © 2021<a href="https://hasthemes.com/">Hasthemes</a>. All Rights Reserved.</p>
                </div>
            </div>
